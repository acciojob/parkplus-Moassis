...
public class PaymentController {
    ...
    @PostMapping("/pay")
    public Payment pay(@RequestParam Integer reservationId, @RequestParam Integer amountSent, @RequestParam String mode)
            throws Exception {
        ...
        // If the mode contains a string other than "cash", "card", or "upi" (any
        // character in uppercase or lowercase), throw "Payment mode not detected"
        // exception.
