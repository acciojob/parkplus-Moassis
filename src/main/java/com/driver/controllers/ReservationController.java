...
public class ReservationController {
    ...
    public Reservation reserveSpot(@RequestParam Integer userId, @RequestParam Integer parkingLotId,
        ...
        // If parkingLot is not found, user is not found, or no spot is available, throw
        // "Cannot make reservation" exception.
        Reservation result = reservationService.reserveSpot(userId, parkingLotId, timeInHours, numberOfWheels);
        return result;
    }
}
